...
class PIIMaskingAgent:
    ...
    def mask_aadhaar(self, aadhaar: str) -> Tuple[str, str]:
...
if __name__ == "__main__":
    ...
    transaction = {
        ...
        "description": "Transfer from PAN ABCDE1234F to account 9876543210",
        "amount": 50000
    }
    ...
    masked = agent.mask_transaction(transaction)
    print("\nMasked Transaction:")
    print(json.dumps(masked, indent=2))
    
    print("\nAudit Trail:")
    print(json.dumps(agent.get_audit_trail(), indent=2))
